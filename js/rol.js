...
function listar_rol(){
     ...
     t_rol.on( 'draw.dt', function () {
        var PageInfo = $('#tabla_perfiles').DataTable().page.info();
...
// modificar datos usuario
    $('#tabla_perfiles').on('click','.editar',function(){
		...
		$('#txt_nombre_actual_rol').val(data.nombre);
		$('#txt_nombre_nuevo_rol').val(data.nombre);
...
function Registrar_Perfil() {
     ...
     var descripcion = $('#txt_desc_rol').val();
 ...
 function Modificar_Perfil() {
      ...
      var rol_actual = $('#txt_nombre_actual_rol').val();
      var rol_nuevo = $('#txt_nombre_nuevo_rol').val();
      var descripcion_rol = $('#txt_desc_rol_editar').val();
