<?php
    class Modelo_Productos extends conexion {
        ...
        function listar() {
            $sql = "SELECT p.id,p.nombre,p.referencia,p.descripcion,p.precioCompra,p.precioVenta,
            p.cantidadInicial,p.compras,p.ventas,p.devoluciones,p.existencias,p.cantidadMinima,p.imagen,p.estado,p.fecha_reg,
